...
export class TasksComponent implements OnInit {
    ...
    @Output()
    filter = new EventEmitter<SearchTask>();
    @Output()
    ...
    @Input('totalTasksFounded')
    set setTotalElements(totalTasksFounded: number){
        this.totalTasksFounded = totalTasksFounded;
        console.log(totalTasksFounded);
    }
    ...
    onFilterByPriority(priority: Priority)  {
      ...
      if (this.selectedPriorityFilter)
        this.search.priorityId = this.selectedPriorityFilter.id;
      else
        this.search.priorityId = null;
      this.onFilter();
    }
    onFilterByStatus(status: any){
      this.selectedStatusFilter = status;
      if (this.selectedStatusFilter)
        this.search.completed = this.selectedStatusFilter;
      else
        this.search.completed = null;
      this.search.completed = this.selectedStatusFilter;
      console.log(this.search);
      this.onFilter();
    }
    onFilterByTitle(): void{
      this.search.title = this.searchTaskText;
      console.log(this.search);
      this.onFilter();
    }
